...
function timer() {
    ...
    var timeInterval = setInterval(function () {
      // As long as the `timeLefttext` is greater than 1
      if (time_left_text >= 1  && question_num < 5) {
        time_left_text--;
        document.getElementById("time_left_text").innerHTML = "time_left_text:" + time_remaining
